        ...
        if self.train_function is None:
            ...
            with K.name_scope('training'):
                ...
                if self.add_trainable_weights is not None:
                    add_training_updates = self.add_optimizer.get_updates(params=self.add_trainable_weights, loss=self.total_loss)
                    updates = (self.updates +
                               training_updates +
                               add_training_updates +
                               self.metrics_updates)
                else:
                    updates = (self.updates +
                               training_updates +
